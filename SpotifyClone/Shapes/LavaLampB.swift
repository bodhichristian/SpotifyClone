...
struct LavaLampB: Shape {
    func path(in rect: CGRect) -> Path {
        Path { path in
            ...
            path.addQuadCurve( // from leading edge
                to: CGPoint(x: rect.width * 0.3, y: rect.height * 0.7),
